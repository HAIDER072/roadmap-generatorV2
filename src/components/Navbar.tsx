...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      <header className={`fixed top-0 left-0 right-0 backdrop-blur-md border-b z-50 transition-colors duration-200 ${darkMode
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center space-x-3 hover:scale-105 transition-transform duration-200">
              ...
              <h1 className={`text-2xl font-bold transition-colors duration-200 ${darkMode
                ? 'text-white'
            ...
            {user && (
              <nav className="hidden md:flex items-center space-x-2">
                <Link
                  to="/dashboard"
                  className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200 ${location.pathname === '/dashboard'
                ...
                <div className="relative">
                  <button
                    ...
                    className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-medium text-sm transition-all duration-200 ${location.pathname === '/create' || location.pathname === '/roadmap' || location.pathname === '/mock-interview'
                      ? 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300'
                      : darkMode
                        ? 'text-slate-300 hover:bg-slate-800 hover:text-white'
                        : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900'
                  ...
                  {showToolsMenu && (
                    <>
                      ...
                      />
                      <div className={`absolute left-0 mt-2 w-64 rounded-xl shadow-lg border py-2 z-50 ${darkMode
                        ...
                        <Link
                          to="/create"
                          onClick={() => setShowToolsMenu(false)}
                          className={`flex items-center space-x-3 px-4 py-3 transition-colors duration-200 ${darkMode
              ...
              {user && (
                <div className="relative">
                  <button
                    ...
                    className={`flex items-center space-x-2 p-2 rounded-lg transition-colors duration-200 ${darkMode ? 'hover:bg-slate-800' : 'hover:bg-slate-100'
                      }`}
                  >
                  ...
                  {showUserMenu && (
                    <div className={`absolute right-0 mt-2 w-56 rounded-xl shadow-lg border py-2 z-50 ${darkMode
                      ? 'bg-slate-800 border-slate-700'
                      : 'bg-white border-slate-200'
                      }`}>
                      ...
                      <div className={`md:hidden border-b ${darkMode ? 'border-slate-700' : 'border-slate-100'
                        }`}>
                        <Link
                          to="/dashboard"
                          className={`flex items-center space-x-2 px-4 py-2 text-sm transition-colors duration-200 ${darkMode
                            ? 'text-slate-300 hover:bg-slate-700'
                            : 'text-slate-700 hover:bg-slate-50'
                            }`}
